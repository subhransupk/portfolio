        ...
        <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="max-w-4xl w-full space-y-8 text-white text-center">
                ...
                <motion.div 
                    ...
                    className="space-y-4"
                >
                    <h1 className="text-6xl md:text-7xl font-bold glitch-text mb-2">
                        Subhransu
                    </h1>
                ...
                <motion.div 
                    ...
                    className="comic-panel bg-opacity-20 bg-black backdrop-blur-sm p-6 rounded-lg border-2 border-cyan-500 relative overflow-hidden group"
                >
                    {/* Spider Web Corner Decorations */}
                    <div className="absolute top-0 left-0 w-16 h-16 border-t-2 border-l-2 border-pink-500 rounded-tl-lg opacity-60" />
                    <div className="absolute top-0 right-0 w-16 h-16 border-t-2 border-r-2 border-cyan-500 rounded-tr-lg opacity-60" />
                    <div className="absolute bottom-0 left-0 w-16 h-16 border-b-2 border-l-2 border-cyan-500 rounded-bl-lg opacity-60" />
                    <div className="absolute bottom-0 right-0 w-16 h-16 border-b-2 border-r-2 border-pink-500 rounded-br-lg opacity-60" />
